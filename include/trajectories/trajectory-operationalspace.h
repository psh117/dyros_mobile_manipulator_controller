...
namespace HQP {
	namespace trajectories {
		...
		class TrajectoryOperationCircle : public TrajectoryBase
		{
		public:
			EIGEN_MAKE_ALIGNED_OPERATOR_NEW

			TrajectoryOperationCircle(const std::string & name);
			TrajectoryOperationCircle(const std::string & name, const Transform3d & init_M, const Transform3d & goal_M, const double & duration, const double & stime);
